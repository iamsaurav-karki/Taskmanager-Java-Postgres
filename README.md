<<<<<<< HEAD
# TaskManager-Java-SpringBoot-Postgres
...
```
cd existing_repo
git remote add origin https://gitlab.com/internship6843914/taskmanager-java-springboot-postgres.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/internship6843914/taskmanager-java-springboot-postgres/-/settings/integrations)
